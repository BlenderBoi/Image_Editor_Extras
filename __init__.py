...
modules = [OT_Open_Viewport, OT_Duplicate_Pack, OT_Save_And_Load, PT_Popup_Panels, Draw_Image_Editor_Header, OT_Next_Slot, OT_Pack_Render, OT_Remove_Image, PROP_Slot_Changer, Preferences]
